...
export const partImage = (part: JourneyPart, journey: JourneySummary | null): string | null => {
...
export const journeyTopic = (journey: JourneySummary): string =>
  journey.categories[0] ?? (journey.contentType ? CONTENT_TYPE_LABELS[journey.contentType as JourneyContentType] : 'Sermon');

export const journeyOverview = (journey: JourneySummary): string =>
