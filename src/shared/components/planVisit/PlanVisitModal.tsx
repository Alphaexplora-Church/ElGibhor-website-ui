            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 md:p-8">
                    ...
                    >
                        ...
                        <div className="absolute bottom-0 left-0 w-64 h-64 bg-royal-purple/20 rounded-full blur-[80px] pointer-events-none" />
                        ...
                        <AnimatePresence mode="wait">
                            {!vm.isSubmitted ? (
                                ...
                                >
                                    {/* Header */}
                                    <div className="mb-8">
                                        <div className="w-12 h-1 bg-gradient-to-r from-gold to-gold/20 rounded-full mb-6" />
                                    ...
                                    <form onSubmit={vm.handleSubmit} className="space-y-5">
                                            ...
                                            <div className="flex flex-col sm:flex-row gap-4">
                                                ...
                                                <label className="flex items-center cursor-pointer group">
                                                    <div className="relative flex items-center">
                                                        ...
                                                        />
                                                        <div className={`w-5 h-5 rounded-full border flex items-center justify-center transition-colors ${vm.formData.type === 'first-time' ? 'border-gold bg-gold/20' : 'border-white/20 bg-white/5 group-hover:border-white/40'}`}>
                                                            {vm.formData.type === 'first-time' && <div className="w-2.5 h-2.5 rounded-full bg-gold" />}
                                                        </div>
                                                    </div>
                                                ...
                                                <label className="flex items-center cursor-pointer group">
                                                    <div className="relative flex items-center">
                                                        ...
                                                        />
                                                        <div className={`w-5 h-5 rounded-full border flex items-center justify-center transition-colors ${vm.formData.type === 'returning' ? 'border-gold bg-gold/20' : 'border-white/20 bg-white/5 group-hover:border-white/40'}`}>
                                                            {vm.formData.type === 'returning' && <div className="w-2.5 h-2.5 rounded-full bg-gold" />}
                                                        </div>
                                                    </div>
                                                    <span className={`ml-3 text-sm transition-colors ${vm.formData.type === 'returning' ? 'text-white font-medium' : 'text-gray-400'}`}>
                                                        Returning Member
                                                    </span>
                                                </label>
                                            </div>
                                        ...
                                        <div className="pt-6">
                                            <button
                                                ...
                                                className="w-full bg-gold text-royal-purple-dark py-4 rounded-xl font-black text-sm sm:text-base hover:bg-gold-light hover:scale-[1.02] active:scale-[0.98] transition-all shadow-[0_0_20px_rgba(239,191,4,0.3)] tracking-wide uppercase disabled:opacity-60 disabled:cursor-not-allowed disabled:scale-100"
                                            >
                                ...
                                >
                                    ...
                                    <button
                                        onClick={onClose}
                                        className="px-8 py-3 bg-white/10 text-white rounded-xl font-bold hover:bg-white/20 transition-colors border border-white/10 text-sm sm:text-base"
                                    >
                                        Close
                                    </button>
                                </motion.div>
