...
const navData = [
  ...
  { 
    ...
    dropdown: [
      ...
      { title: 'Contact Us', sub: 'Get in Touch', path: '/about#contact' }
    ]
  },
  { 
    name: 'Experience', 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-24 items-center">
          ...
          <div className="flex-shrink-0 flex items-center group cursor-pointer z-50">
            <Link to="/" onClick={() => setIsMobileMenuOpen(false)} className="text-2xl font-black tracking-tighter text-white group-hover:text-gold transition-colors duration-300">
              TMGAN
            </Link>
          </div>
          ...
          <div className="hidden lg:flex items-center space-x-4 z-50">
            ...
            <Link to="/watch" className="px-6 py-2.5 rounded-full bg-gold text-royal-purple font-bold tracking-wide hover:shadow-[0_0_20px_rgba(239,191,4,0.4)] transition-all transform hover:-translate-y-0.5">
              Watch Live
            </Link>
          </div>
        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            <motion.div
              ...
              className="fixed inset-0 bg-background-dark z-40 flex items-center justify-center pt-24"
            >
               ...
               <div className="w-full max-w-sm mx-auto px-6 flex flex-col space-y-6 relative z-10">
                  ...
                  <motion.div 
                     ...
                     className="pt-8 border-t border-white/10 flex flex-col space-y-4"
                  >
                     ...
                     <Link to="/watch" onClick={() => setIsMobileMenuOpen(false)} className="w-full py-4 text-center rounded-xl bg-gold text-royal-purple font-black shadow-xl">
                        Watch Live
                     </Link>
                  </motion.div>
               </div>
